...
import (
	serial "v12w.x34y.com/flyfishLib/forkHub/xtls/xray-core/common/serial"
...
type OutboundHandlerConfig struct {
	...
	ForwardSettings	*serial.TypedMessage	`protobuf:"bytes,6,opt,name=forward_settings,json=forwardSettings,proto3" json:"forward_settings,omitempty"`
	unknownFields	protoimpl.UnknownFields
	sizeCache	protoimpl.SizeCache
}
...
func (x *OutboundHandlerConfig) GetForwardSettings() *serial.TypedMessage {
	if x != nil {
		return x.ForwardSettings
	}
	return nil
}
...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\txray.core\x1a!common/serial/typed_message.proto\"\xfb\x01\n" +
	"\x06Config\x129\n" +
	...
	"\x0eproxy_settings\x18\x03 \x01(\v2 .xray.common.serial.TypedMessageR\rproxySettings\"\xbc\x02\n" +
	...
	"\acomment\x18\x05 \x01(\tR\acomment\x12K\n" +
	"\x10forward_settings\x18\x06 \x01(\v2 .xray.common.serial.TypedMessageR\x0fforwardSettingsB=\n" +
...
var file_config_proto_depIdxs = []int32{
	...
	3,	// 8: xray.core.OutboundHandlerConfig.forward_settings:type_name -> xray.common.serial.TypedMessage
